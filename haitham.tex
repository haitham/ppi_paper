...
therefore it is NP-hard\cite{scott}. Scott et al. presented a method for
detecting pathways\cite{scott} using a generic technique devised by Alon et al. called

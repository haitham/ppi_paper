...
\subfigure{
	...
	\includegraphics{results/iterations/hsa6.eps}
}
\subfigure{
	\rule{6cm}{5cm}
	\label{iterations_hsa_8}
	\includegraphics{results/iterations/hsa8.eps}
}
\subfigure{
	\rule{6cm}{5cm}
	\label{iterations_rat_6}
	\includegraphics{results/iterations/rat6.eps}
}
\subfigure{
	\rule{6cm}{5cm}
	\label{iterations_rat_8}
	\includegraphics{results/iterations/rat8.eps}
}
\end{figure}
...
\subfigure{
	\rule{6cm}{5cm}
	\label{times_hsa_6}
	\includegraphics{results/times/time_hsa6.eps}
}
\subfigure{
	\rule{6cm}{5cm}
	\label{times_hsa_8}
	\includegraphics{results/times/time_hsa8.eps}
}
\subfigure{
	\rule{6cm}{5cm}
	\label{times_rat_6}
	\includegraphics{results/times/time_rat6.eps}
}
\subfigure{
	\rule{6cm}{5cm}
	\label{times_rat_8}
	\includegraphics{results/times/time_rat8.eps}
}
\subfigure{
	\rule{6cm}{5cm}
	\label{times_rat_9}
	\includegraphics{results/times/time_rat9.eps}
}
\end{figure}
